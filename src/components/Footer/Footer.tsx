...
const Footer = ({
    ...
    const { dkiceMails, magmetMails, companyAddress, dkicePhoneNumbers, magmetPhoneNumbers } = contactData;

    return (
        <FooterStyled className={clsx(
